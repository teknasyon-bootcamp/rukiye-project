...
<div class="container">
    ...
    <h1 class="mt-4 mb-3">
        <small>En çok  görüntülenenler</small>
    </h1>
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-5">
                <h3><?=$news->title?></h3>
                <p><?=$news->aciklama?></p>
                <a class="btn btn-primary" href="detay.php?id=<?=$news->id?>">Diğer haberler<span class="glyphicon glyphicon-chevron-right"></span>
                </a>
                <hr>
            </div>
        <?php endforeach; ?>
